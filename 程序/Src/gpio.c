...
void MX_GPIO_Init(void)
{
  ...
  HAL_NVIC_DisableIRQ(EXTI15_10_IRQn);  //原本由CubeMX工具生成的代码是HAL_NVIC_EnableIRQ(EXTI15_10_IRQn)
//由于生成的代码总在用户代码之上，而这个中断是需要所有的外设初始化完毕最后才能开启的，所以在这里先失能，在所有外设初始化完成后再使能
